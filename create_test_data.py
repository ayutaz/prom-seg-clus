...
def create_test_data():
    ...
    for i in range(3):  # 3つのサンプル
        ...
        # 2. MFCC特徴量を抽出
        mfcc = librosa.feature.mfcc(y=audio, sr=sr, n_mfcc=13, hop_length=160, n_fft=400)  # 10msホップ
...
def main():
    ...
    print("uv run python prom_seg_clus.py mfcc -1 test_data/audio test_data/features test_data/boundaries test_data/output 5 --extension .wav")
