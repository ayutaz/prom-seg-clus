...
def prepare_directory_structure():
    """必要なディレクトリ構造を作成"""
    dirs = ["data/audio", "data/features/hubert/layer_6", "data/boundaries", "data/output"]
...
def main():
    ...
    # 3. 音声ファイルの準備
    convert_to_wav(librispeech_dir, "data/audio")
    ...
    print("\n3. prom-seg-clusを実行:")
    print(
        "   uv run python prom_seg_clus.py hubert 6 data/audio data/features data/boundaries data/output 5000"
    )
